...
\begin{figure*}[t]
    \centering
    \includegraphics[height=2.5cm]{images/apollo_software_architecture.png}
...
\begin{figure*}[b!]
    ...
    \begin{subfigure}{\columnwidth}
        \centering
        \includegraphics[width=\columnwidth, height=2.5cm]{images/perception_software_architecture.png}
        \caption{Perception Software Architecture}
        \label{perception_software_architecture}
    \end{subfigure}
    \begin{subfigure}{\columnwidth}
        \centering
        \includegraphics[width=\columnwidth,height=2.5cm]{images/obstacle_camera_pipeline.png}
...
%\begin{figure}[b!]
%    \centering
%    \includegraphics[height=2.5cm]{images/perception_software_architecture.png}
%    \caption{Perception Software Architecture}
%    \label{perception_software_architecture}
%\end{figure}
%
%\begin{figure}[b!]
%    \centering
%    \includegraphics[height=2.5cm]{images/obstacle_camera_pipeline.png}
%    \caption{Obstacle Camera Pipeline}
%    \label{obstacle_camera_pipeline}
%\end{figure}
...
\bibitem{b1} Lin, S. C., Zhang, Y., Hsu, C. H., Skach, M., Haque, M. E., Tang, L., \& Mars, J. (2018, March). The architectural implications of autonomous driving: Constraints and acceleration. In ACM SIGPLAN Notices (Vol. 53, No. 2, pp. 751-766). ACM.
%\bibitem{b1} G. Eason, B. Noble, and I. N. Sneddon, ``On certain integrals of Lipschitz-Hankel type involving products of Bessel functions,'' Phil. Trans. Roy. Soc. London, vol. A247, pp. 529--551, April 1955.
\bibitem{b2} Pan, X., Shi, J., Luo, P., Wang, X., \& Tang, X. (2018, April). Spatial as deep: Spatial cnn for traffic scene understanding. In Thirty-Second AAAI Conference on Artificial Intelligence.
